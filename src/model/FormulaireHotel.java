...
public class FormulaireHotel extends Formulaire {
	...
	@Override
	public ReservationHotel traduireReservation() {
		return new ReservationHotel(super.getJour(), super.getMois(), nbLitsSimples, nbLitsDoubles,
				super.getIdentificationEntite());
	}
